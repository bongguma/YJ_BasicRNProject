...
const WeatherView = ({}: Props) => {
    const [weatehrInfo, setWeatherInfo] = useState<IWeather>({
    ...
    let data = [];
    const { isLoading, weather, temperature } = weatehrInfo;
    if (weather && temperature) {
        data.push(weatehrInfo);
    }
        ...
        <Container>
            ...
            renderItem={({ item, index }) => (
                <WeatherItemContainer>
                    <WeatherView>{(item as IWeather).weather}</WeatherView>
